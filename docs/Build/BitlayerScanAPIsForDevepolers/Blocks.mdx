...
Try this endpoint in your [browser](https://api.bitlayer.com/btrscan/api?module=block&action=getblockreward&blockNum=426364&apikey=YourApiKey) 🔗
...
Try this endpoint in your [browser](https://api.bitlayer.com/btrscan/api?module=block&action=getblocknobytime&timestamp=1715789611&closest=before&apikey=YourApiKey) 🔗
